...
export default function CardDemo({ photo, name, description, url }) {
  return (

    <div className="w-56  bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
      <a href="#">
